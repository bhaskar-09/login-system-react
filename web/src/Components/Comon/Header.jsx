								...
								<li>
									...
									<ul className="dropdown-nav">
										<li>
											...
											<ul className="dropdown-nav">
												<li>
													<a href="jobs-list-layout-full-page-map-OpenStreetMap.html">Full Page List + Map</a>
												</li>
												<li>
													<a href="jobs-grid-layout-full-page-map-OpenStreetMap.html">Full Page Grid + Map</a>
												</li>
												<li>
						...
						<div className="header-widget hide-on-mobile">
							...
							<div className="header-notifications">
								...
								<div className="header-notifications-dropdown">
										...
										<div className="header-notifications-scroll" data-simplebar>
											<ul>
												...
												<li className="notifications-not-read">
													<a href="dashboard-messages.html">
														<span className="notification-avatar status-offline">
															<img src="images/user-avatar-small-02.jpg" alt="img" />
														</span>
														<div className="notification-text">
												...
												<li className="notifications-not-read">
													<a href="dashboard-messages.html">
														<span className="notification-avatar status-online">
															<img src="images/user-avatar-placeholder.png" alt="img" />
														</span>
														<div className="notification-text">
									...
									<a href="dashboard-messages.html" className="header-notifications-button ripple-effect button-sliding-icon">
										View All Messages<i className="icon-material-outline-arrow-right-alt"></i>
									</a>
								</div>
							</div>
						</div>
								...
								<div className="header-notifications-trigger">
									<a href="/">
										<div className="user-avatar status-online">
											<img src="images/user-avatar-small-01.jpg" alt="img" />
										</div>
									</a>
								</div>
									...
									<ul className="user-menu-small-nav">
										<li>
											<a href="dashboard.html">
												<i className="icon-material-outline-dashboard"></i> Dashboard
											</a>
										</li>
										<li>
